...
let g:mapleader = ' '    " Default for mappings is now space character instead of /
...
" Keep cursor in the middle of screen shen reopen
autocmd BufReadPost *
...
" Keep cursor in middle when using j k
nnoremap j gjzz
nnoremap k gkzz
...
" Anonymous snippets:
vnoremap <silent> dq dq<C-R>=UltiSnips#Anon('"${1:${VISUAL}}"', 'dq',
            \ '', 'i')<cr>
vnoremap <silent> sq sq<C-R>=UltiSnips#Anon("\'${1:${VISUAL}}\'", 'sq',
            \ '', 'i')<cr>
vnoremap <silent> {{ {{<C-R>=UltiSnips#Anon('{${1:${VISUAL}}\}', '{{',
            \ '', 'i')<cr>
vnoremap <silent> (( ((<C-R>=UltiSnips#Anon('(${1:${VISUAL}})', '((',
            \ '', 'i')<cr>
vnoremap <silent> [[ [[<C-R>=UltiSnips#Anon('[${1:${VISUAL}}]', '[[',
